...
public class SupplierController {
        ...
        @GetMapping
        @Operation(summary = "Lấy danh sách nhà cung cấp", description = "Lấy danh sách tất cả nhà cung cấp (có phân trang)")
        public ResponseEntity<ApiResponse<PageResponse<SupplierResponse>>> getAllSuppliers(
                ...
                PageResponse<SupplierResponse> suppliers = supplierService.getAllSuppliers(page, size);
                return ResponseEntity.ok(
                                ApiResponse.success("Lấy danh sách nhà cung cấp thành công", suppliers));
        }

        @GetMapping("/{id}")
        @Operation(summary = "Lấy thông tin chi tiết nhà cung cấp", description = "Lấy thông tin chi tiết của một nhà cung cấp theo ID")
        public ResponseEntity<ApiResponse<SupplierResponse>> getSupplierById(
                        @Parameter(description = "ID của nhà cung cấp") @PathVariable Long id) {
        ...
        @GetMapping("/search")
        @Operation(summary = "Tìm kiếm nhà cung cấp theo tên", description = "Tìm kiếm nhà cung cấp theo từ khóa trong tên (không phân biệt hoa thường)")
        public ResponseEntity<ApiResponse<List<SupplierResponse>>> searchSuppliersByName(
                        @Parameter(description = "Từ khóa tìm kiếm trong tên nhà cung cấp") @RequestParam String name) {
        ...
        @PostMapping
        @Operation(summary = "Tạo nhà cung cấp mới", description = "Tạo một nhà cung cấp mới")
        ...
        @DeleteMapping("/{id}")
        @Operation(summary = "Xóa nhà cung cấp", description = "Xóa một nhà cung cấp")
